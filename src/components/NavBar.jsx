...
export default function NavBar() {
  return (
    <>
      <div className="flex justify-between items-start py-3 px-14  ">
        ...
        <div className="flex px-4 py-1 items-center text-sm text-black">
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-beigee shadow-sm">
            <img src={burger} alt="burger" className="w-5 h-5" />
          </div>
          <span className="px-3 text-[12px]">Delicious Burger</span>
          <IoIosArrowDown />
          <div className="px-4">
            <img src={noti} alt="noti" className="w-7 h-7 rounded-full px-2" />
          </div>
        </div>
      </div>
